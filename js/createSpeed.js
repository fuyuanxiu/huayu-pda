...
CreateSpeed.prototype = {
    ...
    setData:function (series) {
        ...
        series.forEach(function (item,index) {
            ...
            html += '<li><span class="speed-line"><span id="'+_view_.option.id+index+'" class="speed-num" style="background-color: '+item["color"]+'"></span><span class="numText">'+item["name"]+':'+item["data"]+'</span></span></li>';
        });
